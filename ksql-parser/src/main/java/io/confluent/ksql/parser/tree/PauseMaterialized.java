...
@Immutable
public class PauseMaterialized extends Statement {
  private final QualifiedName materializedViewName;

  public PauseMaterialized(final QualifiedName materializedViewName) {
    this(Optional.empty(), materializedViewName);
  }

  public PauseMaterialized(
  ...
  public boolean equals(final Object obj) {
    ...
    final PauseMaterialized o = (PauseMaterialized) obj;
