...
@Immutable
public class ResumeMaterialized extends Statement {
  private final QualifiedName materializedViewName;

  public ResumeMaterialized(final QualifiedName materializedViewName) {
    this(Optional.empty(), materializedViewName);
  }

  public ResumeMaterialized(
  ...
  public boolean equals(final Object obj) {
    ...
    final ResumeMaterialized o = (ResumeMaterialized) obj;
